...
Из-за отсутствия поддержки драйверов на macOS вы ограничены использованием CPU. Тем не менее, вы можете модифицировать приложение для использования с альтернативами OpenCL.